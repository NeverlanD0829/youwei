...
class depth_estimator(nn.Module):
    ...
    def forward(self, image, x3, x4, x5):

        RGB_fea = self.RGB_CNN(image)
        # Depth CNN
...
if __name__=="__main__":
    ...
    depth = torch.zeros(1,1,352,352)
    x3_r = torch.zeros(1,32,44,44)
    x4_r = torch.zeros(1,32,22,22)
    x5_r = torch.zeros(1,32,11,11)
